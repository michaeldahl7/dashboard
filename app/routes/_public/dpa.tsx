   ...
   return (
      <div className="prose prose-sm max-w-none dark:prose-invert">
         ...
         <p>
            ...
            Personal Data, Customer acts as the controller and the Company as a processor.
         </p>

         <p>
            2.2 The Company shall process Personal Data only on documented instructions
            from Customer, including with regard to transfers of Personal Data to third
            countries, unless required to do so by law.
         </p>
